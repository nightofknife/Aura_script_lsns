...
_SHOP_NAME_TO_KEY: Dict[str, str] = {
    ...
    "铁安局": "battle",
    "市政厅": "city_hall",
    "寿司店": "sushi_restaurant",
    "萝赛": "luosai",
    "黑月服装订单站": "black_moon_clothing_orders",
    "黑月办事处": "black_moon_office",
    "桥梁管理中心": "bridge_administration",
    "大桥管理中心": "bridge_administration",
    "云岫桥军械库": "armory",
    "整顿中心": "reforming_center",
    "垃圾处理中心": "waste_processing_center",
    "水族馆": "aquarium",
    "拉面店": "ramen_restaurant",
    "异想构建室": "ideation_construction_room",
    "汇流之所": "confluence_hub",
    "指挥部": "headquarters",
    "投资中心": "investment_center",
    "交易所": "exchange",
    "交易中心": "exchange",
    "休息区": "rest",
    "休息": "rest",
