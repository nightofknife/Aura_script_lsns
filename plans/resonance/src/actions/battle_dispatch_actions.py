...
@action_info(
    name="resonance.normalize_battle_jobs",
    public=True,
    read_only=True,
    description="Normalize battle jobs by dropping route-incompatible residual fields.",
)
def resonance_normalize_battle_jobs(jobs: List[Dict[str, Any]]) -> Dict[str, Any]:
    if not isinstance(jobs, list):
...
@action_info(
    name="resonance.reconcile_structural_selection",
    public=True,
    read_only=False,
...
def resonance_reconcile_structural_selection(
...
@action_info(
    name="resonance.prepare_battle_formation",
    public=True,
    read_only=False,
...
def resonance_prepare_battle_formation(
...
@action_info(
    name="resonance.wait_and_click_any_text",
    public=True,
    read_only=False,
...
def resonance_wait_and_click_any_text(
    targets: List[str],
    region: Optional[List[int]] = None,
...
def resonance_run_battle_resolution(
