"""City/shop lookup data service for Resonance UI flows."""
...
@service_info(
    alias="resonance_city_shop_data",
    public=True,
    singleton=True,
    description="Resolve Resonance city names and city shop coordinates from static data.",
)
class CityShopDataService:
    ...
    def resolve_city(self, city_text: str, location_file_path: str = "data/meta/location_mumu.json") -> Dict[str, str]:
