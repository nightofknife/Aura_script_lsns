...
@service_info(
    ...
    public=True,
    singleton=True,
    description="Resonance exact full-budget trade planner with legacy planning helpers.",
        ...
        if available_city_ids is None:
            ...
            if unsupported_city_ids:
                raise ResonanceTradePlannerError(
                    ...
                    message="Some selected cities are outside trade constraints.",
                    detail={
        ...
        if resolved_city_id not in allowed_city_ids:
            raise ResonanceTradePlannerError(
                ...
                message=(
                    ...
                    if resolved_city_id in supported_city_ids
                    else f"Current city '{resolved_city_id}' is outside trade constraints."
                ),
